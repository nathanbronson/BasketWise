...
use_all = False #@param {type:"boolean"}
...
model1.add(Dense(496, kernel_initializer="uniform", activation="relu"))
model1.add(Dense(248, kernel_initializer="uniform", activation="relu"))
...
if use_all:
  model1.fit(X, y, batch_size=64, epochs=50, verbose=1, validation_data=(X_test, y_test))
else:
